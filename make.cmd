...
cscript //Nologo "C:\Programming\FreeBASIC Projects\Test Runtime Library\RemoveLines.vbs" "WebServer.asm" "Network.asm" "ThreadProc.asm" "ThreadProc.asm" "ReadHeadersResult.asm" "WebUtils.asm" "ProcessRequests.asm" "base64-decode.asm" "Mime.asm" "Http.asm" "WebSite.asm"
...
del *.o *.obj *.asm
copy /y *.bas "C:\Programming\‘ ©βλ\www.freebasic.su\code\freebasic-webserver\"
copy /y *.bi "C:\Programming\‘ ©βλ\www.freebasic.su\code\freebasic-webserver\"
copy /y *.ini "C:\Programming\‘ ©βλ\www.freebasic.su\code\freebasic-webserver\"
copy /y *.rc "C:\Programming\‘ ©βλ\www.freebasic.su\code\freebasic-webserver\"