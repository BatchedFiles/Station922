...
$(OBJ_DEBUG_DIR)$(PATH_SEP)HeapMemoryAllocator$(FILE_SUFFIX).c: src$(PATH_SEP)HeapMemoryAllocator.bi src$(PATH_SEP)IHeapMemoryAllocator.bi src$(PATH_SEP)IClientSocket.bi src$(PATH_SEP)ITimeCounter.bi src$(PATH_SEP)Logger.bi
$(OBJ_RELEASE_DIR)$(PATH_SEP)HeapMemoryAllocator$(FILE_SUFFIX).c: src$(PATH_SEP)HeapMemoryAllocator.bi src$(PATH_SEP)IHeapMemoryAllocator.bi src$(PATH_SEP)IClientSocket.bi src$(PATH_SEP)ITimeCounter.bi src$(PATH_SEP)Logger.bi
...
$(OBJ_DEBUG_DIR)$(PATH_SEP)NetworkAsyncStream$(FILE_SUFFIX).c: src$(PATH_SEP)NetworkAsyncStream.bi src$(PATH_SEP)INetworkAsyncStream.bi src$(PATH_SEP)IBaseAsyncStream.bi src$(PATH_SEP)IAsyncResult.bi src$(PATH_SEP)AsyncResult.bi src$(PATH_SEP)IClientSocket.bi src$(PATH_SEP)ITimeCounter.bi src$(PATH_SEP)Network.bi
$(OBJ_RELEASE_DIR)$(PATH_SEP)NetworkAsyncStream$(FILE_SUFFIX).c: src$(PATH_SEP)NetworkAsyncStream.bi src$(PATH_SEP)INetworkAsyncStream.bi src$(PATH_SEP)IBaseAsyncStream.bi src$(PATH_SEP)IAsyncResult.bi src$(PATH_SEP)AsyncResult.bi src$(PATH_SEP)IClientSocket.bi src$(PATH_SEP)ITimeCounter.bi src$(PATH_SEP)Network.bi
