...
Const CLIENTREQUEST_E_HEADERFIELDSTOOLARGE As HRESULT =     MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, &h0421)
Const CLIENTREQUEST_E_SOCKETERROR As HRESULT =              MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, &h0422)
Const CLIENTREQUEST_E_EMPTYREQUEST As HRESULT =             MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, &h0423)
Const CLIENTREQUEST_E_BADHOST As HRESULT =                  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, &h0424)
Const CLIENTREQUEST_E_BADREQUEST As HRESULT =               MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, &h0425)
Const CLIENTREQUEST_E_BADPATH As HRESULT =                  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, &h0426)
Const CLIENTREQUEST_E_PATHNOTFOUND As HRESULT =             MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, &h0427)
Const CLIENTREQUEST_E_URITOOLARGE As HRESULT =              MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, &h0428)
Const CLIENTREQUEST_E_HTTPVERSIONNOTSUPPORTED As HRESULT =  MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, &h0429)

Const HTTPASYNCPROCESSOR_E_RANGENOTSATISFIABLE As HRESULT = MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, &h0431)
...
Const WEBSITE_E_NOTIMPLEMENTED As HRESULT =                 MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, &h0443)
Const WEBSITE_E_FILENOTFOUND As HRESULT =                   MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, &h0444)
Const WEBSITE_E_FILEGONE As HRESULT =                       MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, &h0445)
Const WEBSITE_E_FORBIDDEN As HRESULT =                      MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, &h0446)
