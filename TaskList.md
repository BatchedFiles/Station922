...
[ ] Пул объектов: `HeapMemoryAllocator`, `HttpReader`, `NetworkStream`.
[ ] Размер пула не задан: объекты создаются в обход пула
[ ] Размер пула задан: расширять или не расширять пул
