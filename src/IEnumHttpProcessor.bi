...
Type IEnumHttpProcessorVirtualTable
	...
	QueryInterface As Function( _
		ByVal self As IEnumHttpProcessor Ptr, _
...
#define IEnumHttpProcessor_QueryInterface(self, riid, ppv) (self)->lpVtbl->QueryInterface(self, riid, ppv)
#define IEnumHttpProcessor_AddRef(self) (self)->lpVtbl->AddRef(self)
#define IEnumHttpProcessor_Release(self) (self)->lpVtbl->Release(self)
