...
Type IEnumWebSiteVirtualTable
	...
	QueryInterface As Function( _
		ByVal self As IEnumWebSite Ptr, _
...
#define IEnumWebSite_QueryInterface(self, riid, ppv) (self)->lpVtbl->QueryInterface(self, riid, ppv)
#define IEnumWebSite_AddRef(self) (self)->lpVtbl->AddRef(self)
#define IEnumWebSite_Release(self) (self)->lpVtbl->Release(self)
