...
#define IHttpOptionsAsyncProcessor_BeginProcess(this, pContext, pcb, StateObject, ppIAsyncResult) (this)->lpVtbl->BeginProcess(this, pContext, pcb, StateObject, ppIAsyncResult)
